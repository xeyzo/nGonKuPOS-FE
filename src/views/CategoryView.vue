<template>
  <div class="bg-white p-4 sm:p-6 rounded-lg shadow-xl border border-gray-200">
    <div class="flex flex-col sm:flex-row justify-between items-center mb-6 gap-4">
      ...
      <button @click="categoryStore.openAddModal" class="bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 text-white font-medium rounded-lg text-sm px-5 py-2.5 w-full sm:w-auto">
        Add Category
      </button>
    </div>
        ...
        <tbody class="bg-white divide-y divide-gray-200 border-t border-gray-200">
          <tr v-for="(category, index) in categoryStore.paginatedCategories" :key="category.id" class="hover:bg-gray-50">
            ...
            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
              ...
              <button @click="confirmDelete(category.id)" class="text-red-600 hover:text-red-900 inline-flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1" viewBox="0 0 20 20" fill="currentColor">
